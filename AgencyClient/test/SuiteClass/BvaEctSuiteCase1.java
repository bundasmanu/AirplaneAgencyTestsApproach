...
public class BvaEctSuiteCase1{
    ...
    public static void beforeTests() throws NoPermissionException, NamingException {
        ...
        //create an user
        TUserDTO userDTO = Operations.createTestUser(Operations.getAgencyRemote());
        ...
        purchaseDTO = Operations.buyAndFinishPurchase(Operations.getAgencyRemote(), tripDTO);
        
    }
            
    public BvaEctSuiteCase1(int feedbackScore, boolean done, FeedbackResult res) {
    ...
    public void testSeveral() throws NoPermissionException {
        ...
        Operations.getAgencyRemote().editTrip(tripDTO);
        
        Operations.signinAsTestUser(Operations.getAgencyRemote());
        
        boolean booleanResult = Operations.getAgencyRemote().addFeedbackToTrip(tripDTO, tripFeedbackDTO);
